...
class HTML_Template_xFastTemplate2 extends xft2_fms
{
	 ...
	 *
	 */
	public $versionStr = "0.3.1 @RC2 PHP 5.2.x - WB2.8.1[2010-05-11]";
	...
	*/
	 ...
	 *	Private
	 */
	private function _get_xhtml1_meta_tag ($aHttp_equiv= "", $aContent="", $aType="name") {
	 ...
	 *	M.f.i.
	 */
	private function _build_xhtml1_img_tag ($aFileName="", $aAltStr="") {
	...
	private function __get_modules_files ($aPath) {
		$f = array (
			'css' => array (
				'/css/frontend.css',
				'/frontend.css'
